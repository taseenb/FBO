var FBO = function (exports) {
  ...
  exports.init = function (width, height, renderer, simulationMaterial, renderMaterial) {
    ...
    var options = {
      ...
      type: THREE.HalfFloatType //important as we need precise coordinates (not ints)
      // NOTE: use HalfFloatType, as FloatType is not supported on mobiles (or at least on IOS Safari)
    };
